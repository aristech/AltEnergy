...
class ManagerDamageResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            "editable" => array([
                "resource" => "damages",
                "id" => $this->id,
                "manager_share" => ["field" => "cost", "value" => $this->cost, "type" => "float", "title" => "Τιμή", "required" => false]
                // "info" => [
                //     "client_lastname" => $this->client['lastname'],
                //     "client_firstname" => $this->client['firstname'],
                ...
                // "status" => ["field" => "status", "value" => $this->status, "type" => "boolean", "title" => "Κατάσταση", "radioItems" => [["id" => "Ολοκληρώθηκε", "title" => "Ολοκληρώθηκε"], ["id" => "Μη Ολοκληρωμένη", "title" => "Μη Ολοκληρωμένη"], ["id" => "Ακυρώθηκε", "title" => "Ακυρώθηκε"]], "required" => true],
