        ...
        return
            [
                ...
                "editable" => array([
                    ...
                    "parallagi_sxedion" => ["roles" => array(5, 4, 3), "field" => "parallagi_sxedion", "value" => $this->parallagi_sxedion, "type" => "boolean", "title" => "ΠΑΡΑΛΛΑΓΗ ΣΧΕΔΙΩΝ", "radioItems" => [["id" => 0, "title" => "ΟΧΙ"], ["id" => 1, "title" => "ΝΑΙ"]], "required" => true],
