        ...
        return
            [
                ...
                "editable" => array([
                    ...
                    "guarantee" => ["field" => "guarantee", "value" => $this->guarantee, "type" => "boolean", "title" => "Εγγύηση", "radioItems" => [["id" => true, "title" => "Με εγγύηση"], ["id" => false, "title" => "Χωρίς εγγύηση"]], "required" => true],
                    "appointment_pending" => ["field" => "appointment_pending", "value" => $this->appointment_pending, "type" => "boolean", "title" => "Αναμονή ραντεβού", "radioItems" => [["id" => false, "title" => "Οχι"], ["id" => true, "title" => "Ναι"]], "required" => true],
                    "technician_left" => ["field" => "technician_left", "value" => $this->technician_left, "type" => "boolean", "title" => "Αποχώρηση Τεχνικού", "radioItems" => [["id" => false, "title" => "Οχι"], ["id" => true, "title" => "Ναι"]], "required" => true],
                    "technician_arrived" => ["field" => "technician_arrived", "value" => $this->technician_arrived, "type" => "boolean", "title" => "Άφηξη Τεχνικού", "radioItems" => [["id" => false, "title" => "Οχι"], ["id" => true, "title" => "Ναι"]], "required" => true],
                    "appointment_completed" => ["field" => "appointment_completed", "value" => $this->appointment_completed, "type" => "boolean", "title" => "Ολοκλήρωση Ραντεβού", "radioItems" => [["id" => false, "title" => "Οχι"], ["id" => true, "title" => "Ναι"]], "required" => true],
                    "appointment_needed" => ["field" => "appointment_needed", "value" => $this->appointment_needed, "type" => "boolean", "title" => "Ανάγκη για Νέο Ραντεβού", "radioItems" => [["id" => false, "title" => "Οχι"], ["id" => true, "title" => "Ναι"]], "required" => true],
                    "supplement_pending" => ["field" => "supplement_pending", "value" => $this->supplement_pending, "type" => "boolean", "title" => "Αναμονή Ανταλλακτικού", "radioItems" => [["id" => false, "title" => "Οχι"], ["id" => true, "title" => "Ναι"]], "required" => true],
                    "damage_fixed" => ["field" => "damage_fixed", "value" => $this->damage_fixed, "type" => "boolean", "title" => "Βλάβη Επιδιορθώθηκε", "radioItems" => [["id" => false, "title" => "Οχι"], ["id" => true, "title" => "Ναι"]], "required" => true],
                    "completed_no_transaction" => ["field" => "completed_no_transaction", "value" => $this->completed_no_transaction, "type" => "boolean", "title" => "Ολοκλήρωση χωρίς συναλλαγή", "radioItems" => [["id" => false, "title" => "Οχι"], ["id" => true, "title" => "Ναι"]], "required" => true],
