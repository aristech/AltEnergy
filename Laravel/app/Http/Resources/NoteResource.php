    ...
    public function toArray($request)
    {
        ...
        [
            ...
            "editable" => array([
                ...
                "importance" => ["field" => "all_day", "value" => $this->all_day, "type" => "boolean", "title" => "Σημαντικότητα", "radioItems" => [["id" => 0, "title" => "Υψηλή"], ["id" => 1, "title" => "Μεσαία"], ["id" => 2, "title" => "Χαμηλή"]], "required" => true],
