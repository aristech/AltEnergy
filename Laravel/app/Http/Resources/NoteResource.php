    ...
    public function toArray($request)
    {
        ...
        [
            ...
            "editable" => array([
                ...
                "dateTime_start" => ["field" => "dateTime_start", "title" => "Έναρξη", "type" => "datetime", "value" => $this->dateTime_start, "required" => false],
                "dateTime_end" => ["field" => "dateTime_end", "title" => "Λήξη", "type" => "datetime", "value" => $this->dateTime_end, "required" => false]
            ])
        ];
    }
}
